...
# 1. Cast numeric features to correct data-type.
# 2. For fields wXX_Mtotal and lastXXWeekOnLine, change null to 0. 

if __name__ == "__main__":
    dir0 = 'file:///home/cloudera/2.kkbox_churn/data01/big_table_01/'
    infile = dir0 + 'all_features'
    outfile = dir0 + '11.all_features_clean1'
    ...
    for c in df0.columns:
        ...
        elif c in ['has_long_gap', 'has_expired', 'auto_renew_mode', 'is_churn']:
